...
try:
    best_xgb_model = pickle.load(open('best_xgb_model.pkl', 'rb'))
    scaler = pickle.load(open('scaler.pkl', 'rb'))
    label_encoder = pickle.load(open('label_encoder.pkl', 'rb'))
except FileNotFoundError:
    st.error("Model components not found. Please make sure 'best_xgb_model.pkl', 'scaler.pkl', and 'label_encoder.pkl' are in the same directory.")
    st.stop()
